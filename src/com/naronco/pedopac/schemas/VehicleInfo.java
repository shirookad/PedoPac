...
public class VehicleInfo extends Table {
  ...
  public double engineForce() { int o = __offset(6); return o != 0 ? bb.getDouble(o + bb_pos) : 272; }
  ...
  public double steeringClamp() { int o = __offset(12); return o != 0 ? bb.getDouble(o + bb_pos) : 0.3; }
  ...
  public static void addEngineForce(FlatBufferBuilder builder, double engineForce) { builder.addDouble(1, engineForce, 272); }
  ...
  public static void addSteeringClamp(FlatBufferBuilder builder, double steeringClamp) { builder.addDouble(4, steeringClamp, 0.3); }
