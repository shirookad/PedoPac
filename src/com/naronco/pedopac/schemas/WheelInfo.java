...
public class WheelInfo extends Table {
  public static WheelInfo getRootAsWheelInfo(ByteBuffer _bb) { return getRootAsWheelInfo(_bb, new WheelInfo()); }
  public static WheelInfo getRootAsWheelInfo(ByteBuffer _bb, WheelInfo obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public WheelInfo __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static void startWheelInfo(FlatBufferBuilder builder) { builder.startObject(3); }
  ...
  public static int endWheelInfo(FlatBufferBuilder builder) {
