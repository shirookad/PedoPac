...
public class VehicleWheelInfo extends Table {
  ...
  public double wheelRadius() { int o = __offset(8); return o != 0 ? bb.getDouble(o + bb_pos) : 0.387; }
  ...
  public static void addWheelRadius(FlatBufferBuilder builder, double wheelRadius) { builder.addDouble(2, wheelRadius, 0.387); }
